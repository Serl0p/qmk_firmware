...
#define USER_BlE_ID                 (0X001C)
#define USER_BlE1_NAME              "Hack59-1"
#define USER_BlE2_NAME              "Hack59-2"
#define USER_BlE3_NAME              "Hack59-3"
...
/************************矩阵按键相关变量********************/
/************************矩阵按键相关变量********************/
bool     Key_KC_D_Status;
bool     Key_KC_I_Status;
bool     Key_KC_F_Status;
bool     Key_KC_R_Status;

bool Key_Value_Dispose(uint16_t keycode, keyrecord_t *record);
// void FN_CTRL_Mode_Key_Press(void);
// void FN_CTRL_Mode_Key_Release(void);
...
#define USER_BATT_LOW_POWER         (2070)      //低电 2065 * 3.3 /4096 = 1.663 3.32V     即使键盘不开灯，电池满电4.2V
...
#define LED_ESC_INDEX       (53)
#define LED_BAT_INDEX       (52)
#define LED_CAP_INDEX       (28)
#define LED_ARTL_INDEX      (58)
